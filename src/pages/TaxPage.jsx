...
export function TaxPage(){
    ...
    return (
        <div>  
            <div className='flex'>
                <button onClick={openTaxModal}>Create Tax </button>
            </div>
            ...
            <TaxForm  closeModal={closeModal} modalIsOpen={modalIsOpen} el={ref} items={groupBy(taxes, 'name')} ></TaxForm>
        </div>
    )
}